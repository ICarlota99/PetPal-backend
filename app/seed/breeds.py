breeds = {
    "dog": [
        "Mixed", "Affenpinscher", "Afghan Hound", "Airedale Terrier", "Akita",
        ...
        "Black and Tan Coonhound", "Black Russian Terrier", "Border Collie", "Border Terrier",
        "Borzoi", "Boston Terrier", "Bouvier des Flandres", "Boxer", "Boykin Spaniel",
        "Briard", "Brittany", "Bull Terrier", "Bulldog", "Bullmastiff", "Cairn Terrier",
        ...
        "Cocker Spaniel", "Collie", "Coonhound", "Corgi", "Cotton de Tulear",
        "Curly-Coated Retriever", "Dachshund", "Dalmatian", "Dandie Dinmont Terrier",
        "Doberman Pinscher", "Dogo Argentino", "Dutch Shepherd", "English Bulldog",
        ...
        "Glen of Imaal Terrier", "Goldador", "Golden Retriever", "Goldendoodle",
        ...
        "Kerry Blue Terrier", "King Charles Spaniel", "Klee Kai", "Labrador Retriever",
        "Lagotto Romagnolo", "Lhasa Apso", "Maltese", "Manchester Terrier", "Maremma Sheepdog",
        "Mastiff", "Miniature American Shepherd", "Miniature Bull Terrier", "Miniature Schnauzer",
        "Neapolitan Mastiff", "Newfoundland", "Norfolk Terrier", "Norwegian Buhund",
        "Norwegian Elkhound", "Norwegian Lundehund", "Old English Sheepdog", "Otterhound",
        "Papillon", "Parson Russell Terrier", "Pekingese", "Pembroke Welsh Corgi",
        "Petit Basset Griffon Vendéen", "Pharaoh Hound", "Plott", "Pointer",
        "Polish Lowland Sheepdog", "Pomeranian", "Poodle", "Portuguese Water Dog",
    ...
    "cat": [
        "Mixed", "Abyssinian", "American Bobtail", "American Curl", "American Shorthair",
        "American Wirehair", "Balinese", "Bengal", "Birman", "Bombay", "British Shorthair",
        "Burmese", "Burmilla", "Chartreux", "Colorpoint Shorthair", "Cornish Rex", "Devon Rex",
        "Egyptian Mau", "European Burmese", "Exotic", "Havana Brown", "Japanese Bobtail",
        "Khao Manee", "Korat", "LaPerm", "Lykoi", "Maine Coon", "Manx", "Norwegian Forest Cat",
